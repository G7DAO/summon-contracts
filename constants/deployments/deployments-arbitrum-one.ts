...
export const ARBITRUM_ONE_CONTRACTS: DeploymentContract[] = [
    ...
    {
        contractFileName: CONTRACT_UPGRADABLE_FILE_NAME.MockWETH,
        type: CONTRACT_TYPE.MockWETH,
        name: CONTRACT_NAME.MockWETH,
        chain,
        networkType,
        tenants: [ TENANT.Game7 ],
        verify: true,
        ...
        dependencies: [],
        functionCalls: [],
        args: [ "KaracurtToken", "KRT", 18, "10000000000000000000000000000" ],
    }
];
