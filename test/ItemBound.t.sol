...
contract ItemBoundTest is Test {
    ...
    function generateTokenId(uint256 item, LibItems.Tier tier) internal pure returns (uint256) {
        return uint256(keccak256(abi.encodePacked(item, tier)));
    }
    ...
    function setUp() public {
        ...
        tokenId = generateTokenId(1000, LibItems.Tier.RARE);
    ...
    //     uint256 _tokenId = generateTokenId(1000, LibItems.Tier.RARE);
